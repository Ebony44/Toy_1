...
{
    [AddComponentMenu("VFX/Property Binders/My Multiple Position Binder")]
    [VFXBinder("Point Cache/My Multiple Position Binder")]
    public class MyMultiplePositionBinder : VFXBinderBase
    {
